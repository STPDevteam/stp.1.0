## STPcoin Metadata Specification

Additional fields may be added, but will be ignored by STPcoin.
...
```
{
   ...
   "contract_signature": "<STPcoin signed contract_hash>",
