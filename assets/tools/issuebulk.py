#!/usr/bin/env python3
# Script to issue assets on the STPcoin platform
...
# Prerequisite: stpd daemon to be running
...
#Set this to your stp-cli program
cli = "stp-cli"
...
#mode =  "-regtest"
#rpc_port = 18443
csv_file = "STP Assets - Sheet1.csv"
#Set this information in your stp.conf file (in datadir, not testnet3)
rpc_user = 'rpcuser'
rpc_pass = 'rpcpass555'
