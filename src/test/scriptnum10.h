...
#ifndef STP_TEST_SCRIPTNUM10_H
#define STP_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from STP Core 0.10.0, for cross-comparison.
 */
public:
