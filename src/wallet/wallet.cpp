...
std::map<CTxDestination, std::vector<COutput>> CWallet::ListAssets() const
{
    ...
    // https://github.com/STPProject/STPcoin/pull/10340, but that change has been
    // postponed until after https://github.com/STPProject/STPcoin/pull/10244 to
                                   ...
                                   const AssetType& assetType, bool sign)
{
    ...
    unsigned int nBytes;
    {
        ...
        LOCK2(cs_main, cs_wallet);
        {
            ...
            // change transaction isn't always pay-to-stp-address
 ...
 * https://stptalk.org/?topic=54527, or
 * https://github.com/STPProject/STPcoin/pull/1393.
 */
