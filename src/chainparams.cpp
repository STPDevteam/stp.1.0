...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1514999494, 25023712, 0x1e00ffff, 4, 125 * COIN);
        ...
        chainTxData = ChainTxData{
            // Update as we know more about the contents of the STP chain
        ...
        // Burn Addresses
        strIssueAssetBurnAddress = "STissueAssetXXXXXXXXXXXXXXXXXhhZGt";
        strReissueAssetBurnAddress = "STReissueAssetXXXXXXXXXXXXXXVEFAWu";
        strIssueSubAssetBurnAddress = "STissueSubAssetXXXXXXXXXXXXXWcwhwL";
        strIssueUniqueAssetBurnAddress = "STissueUniqueAssetXXXXXXXXXXWEAe58";

        //Global Burn Address
        strGlobalBurnAddress = "STBurnXXXXXXXXXXXXXXXXXXXXXXWUo9FV";
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(nGenesisTime, 15615880, 0x1e00ffff, 2, 125 * COIN);
        ...
        vSeeds.emplace_back("seed.stp.network", false);
...
=======
        ...
        genesis = CreateGenesisBlock(1524179366, 1, 0x207fffff, 4, 125 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
>>>>>>> stp.network init
