...
class TestSTPCli(STPTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `stp-cli getinfo`")
        ...
        self.log.info("Compare responses from `stp-cli -getinfo` and the RPCs data is retrieved from.")
