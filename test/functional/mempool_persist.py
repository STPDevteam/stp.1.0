...
By default, stpd will dump mempool on shutdown and
...
class MempoolPersistTest(STPTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give stpd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent stpd from writing mempool.dat to disk. Verify that `savemempool` fails")
