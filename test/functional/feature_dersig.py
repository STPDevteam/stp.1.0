...
class BIP66Test(STPTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # stpd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and stpd produces more specific reject
            # reasons.
