...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the STPTestFramework
    pass

class ExampleTest(STPTestFramework):
    # Each functional test is a subclass of the STPTestFramework class.
    ...
    def custom_method(self):
        ...
        STPTestFramework class so other tests can use it."""
