...
from test_framework.test_framework import STPTestFramework, SkipTest
...
class ZMQTest (STPTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that stp has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("stpd has not been built with zmq enabled.")
