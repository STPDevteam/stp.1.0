...
class AssetTest(STPTestFramework):
    ...
    def big_test(self):
        ...
        n0.listassets(asset="STP*", verbose=False, count=2, start=-2)
        ...
        stp_assets = n0.listassets(asset="STP*", verbose=False, count=2, start=-2)
        assert_equal(len(stp_assets), 2)
        assert_equal(stp_assets[0], "STP2")
        assert_equal(stp_assets[1], "STP3")
        self.sync_all()
