...
# TestNode: A peer we use to send messages to stpd, and store responses.
...
class CompactBlocksTest(STPTestFramework):
    ...
    # This test actually causes stpd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that stpd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for stpd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # stpd will not send blocktxn responses for blocks whose height is
